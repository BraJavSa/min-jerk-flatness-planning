 ...
 * the 6-param Min-Jerk QP + pseudo-flatness in C, and exports the full
...
int main(int argc, char *argv[])
{
    ...
    /* 5. Minimum-Jerk QP Planning (timed) */
    double t_qp0 = now_ms();
    ...
    /* 6. Pseudo-Flatness Reconstruction (timed) */
    double t_fl0 = now_ms();
    ...
    if (fm) {
        fprintf(fm,
            "{\n"
            "    \"case\": \"Case 2 Semilla Realtime (C)\",\n"
