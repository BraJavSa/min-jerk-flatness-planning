...
#
# This script does NOT compute anything: it only reads the CSV files
# produced by the C binaries (./main and ./simulate_openloop) and
# renders the diagnostic plots, mirroring the original Python outputs.
...
def plot_planning(script_dir):
    ...
    plt.close()
    print(f"[plot_results] Planning plot saved to: {out_path}")
