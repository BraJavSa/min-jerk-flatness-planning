 ...
 * validated in open loop against the full 9-Parameter identified
 * dynamics plant.
 */
#include <stdio.h>
#include <stdlib.h>
...
int main(void)
{
    ...
    /* state_real = X_ref_all[0] = [x0, y0, psi0, u0, v0, r0] */
    double state_real[6];
    ...
    printf("\n==================================================\n");
    printf("CASE 2 SEMILLA OPEN-LOOP TRAJECTORY METRICS (9-PARAM):\n");
