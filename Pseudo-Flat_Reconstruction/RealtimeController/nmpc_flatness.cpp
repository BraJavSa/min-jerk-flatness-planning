...
struct NmpcFlatness::Impl {
    ...
    void build_opti() {
        ...
        tau_u = m11_9 * du - m22_9 * v * r + Xu_9 * u + Xuu_9 * fabs(u) * u;
        tau_v = m22_9 * dv + m11_9 * u * r + Yv_9 * v + Yvv_9 * fabs(v) * v;
        tau_r = m33_9 * dr - (m11_9 - m22_9) * u * v + Nr_9 * r + Nrr_9 * fabs(r) * r;
        ...
        // Underactuation constraint on sway force
