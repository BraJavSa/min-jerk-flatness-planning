...
from usv_params import (
    ...
    cmd_from_thrust, thrust_from_cmd
)
...
class NmpcFlatness:
    ...
    def _build_opti(self):
        ...
        # 5-parameter differential flatness model (m11 = m22 = m_5)
        tau_u = m_5 * du - m_5 * v * r + Xu_5 * u
        tau_v = m_5 * dv + m_5 * u * r + Yv_5 * v
        tau_r = m33_5 * dr + Nr_5 * r
        ...
        # Underactuation condition (exact 5-parameter flatness model)
