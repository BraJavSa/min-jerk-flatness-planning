...
struct NmpcFlatness::Impl {
    ...
    void build_opti() {
        ...
        // Differential Flatness 5-parameter USV dynamics (Mass Symmetry: m11 = m22 = m_5)
        ...
        // Underactuation constraint on sway force (exact 5-parameter model flatness condition)
