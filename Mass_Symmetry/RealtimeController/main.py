...
def generate_launch_description():
    ...
    planner_node = Node(
        ...
        executable='mass_symmetry_planner',
        name='mass_symmetry_planner',
        output='screen',
        parameters=[{
    ...
    mpc_node = Node(
        package=PACKAGE_NAME,
        executable='mass_symmetry_mpc_node',
        name='mass_symmetry_mpc_node',
        output='screen',
        parameters=[{
            'output_dir': LaunchConfiguration('output_dir'),
            'odom_topic': LaunchConfiguration('odom_topic'),
    ...
    recorder_node = Node(
        package=PACKAGE_NAME,
        executable='mass_symmetry_recorder',
        name='mass_symmetry_recorder',
        output='screen',
        parameters=[{
            'output_dir': LaunchConfiguration('output_dir'),
            'odom_topic': LaunchConfiguration('odom_topic'),
