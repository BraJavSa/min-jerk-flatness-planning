...
class Case3MpcNode(Node):
    def __init__(self):
        ...
        self.pub_telemetry = self.create_publisher(Float64MultiArray, '/case3_mpc/telemetry', 10)
        ...
        self.get_logger().info(
            f'Case 3 MPC Node initialized (Horizon N={self.nmpc.N}, dt={self.dt:.4f}s). '
    ...
    def control_loop(self):
        ...
        if not self.started:
            ...
            self.get_logger().info('Starting 30Hz closed-loop Case 3 NMPC control execution...')
