 ...
 *
 * Solo planificación (equivalente a main.py). Imprime el tiempo de
 * resolución del QP y el de la reconstrucción por planitud.
 */
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
int main(void) {
    ...
    /* --- Reconstrucción por planitud (timed) --- */
    ...
    printf("==================================================\n");
    printf("CASE 1 (C) - Planificacion QP + Reconstruccion por planitud\n");
    printf("--------------------------------------------------\n");
