/* Technique: Case 1 - validacion en lazo abierto de la planificacion QP
 * (5-param flatness) contra la planta completa no lineal (9-param).
...
int main(void) {
    ...
    /* Historial del estado real para poder graficarlo despues */
    ...
    /* --- Simulacion en lazo abierto (RK4), timed --- */
